...
public class AdapterContact extends RecyclerView.Adapter<AdapterContact.ContactViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
        ...
        String latitude = modelContact.getLatitude();
        String longitude = modelContact.getLongitude();
        ...
        holder.contactDial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(context.getApplicationContext(), "Calling " + name + "...", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // create intent to move to ContactDetails Activity with contact id as reference
