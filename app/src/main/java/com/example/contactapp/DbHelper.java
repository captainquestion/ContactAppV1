...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public long insertContact(String image,String name,String phone,String email,String note,String addedTime,String updatedTime, String latitude, String longitude){
        ...
        contentValues.put(Constants.C_LATITUDE, latitude);
        contentValues.put(Constants.C_LONGITUDE, longitude);
    ...
    public void updateContact(String id,String image,String name,String phone,String email,String note,String addedTime,String updatedTime, String latitude, String longitude){
        ...
        if (cursor.moveToFirst()){
            do {
                ModelContact modelContact = new ModelContact(
                        ...
                        ""+cursor.getString(cursor.getColumnIndexOrThrow(Constants.C_LATITUDE)),
                        ""+cursor.getString(cursor.getColumnIndexOrThrow(Constants.C_LONGITUDE))
                );
